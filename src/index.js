...
appNode.className = 'flex flex-wrap';
...
const cardContainer = async (city) => {
  ...
  card.className = 'border-solid border-2 border-blue-600 bg-blue-900 w-40 h-80 mx-auto rounded-xl mt-10 p-4 ';
...
btnSearch.addEventListener('click', async (event) => {
  ...
  try {
    await cardContainer(inputCity.value)
